...
pg.init()
fps = 30
Clock = pg.time.pygame.time.Clock()
screen = pg.display.set_mode((width, height+100),0,32)
pg.display.pygame.display.set_caption("Tic Tac Toe", icontitle=None)
...
#resizing image
x_img = pg.transform.scale(opening, (width, height+100))
...
def check_win():
    ...
    if (TTT[0][2] == TTT[1][1] == TTT[2][0]) and (TTT[0][2] is not None):
        #game won diagnollay right to left
        winner = TTT[0][2]
...
def userClick():
    ...
    #get collumn of mouse click (1-3)
    if(x<width/3):
        col = 1
    elif(x<width/3*2):
        col = 2
